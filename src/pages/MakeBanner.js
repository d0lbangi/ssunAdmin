...
const ExposePeriod = styled(InfoContent)``;
const BannerTitle = styled(InfoContent)``;
const LinkAPI  = styled(InfoContent)``;
    ...
    <React.Fragment>
      <AdminContainer>
        <ChallengeInfo>
          ...
          <InfoItem>
            <InfoItemName>노출 기간</InfoItemName>
            <ExposePeriod>내용</ExposePeriod>
          </InfoItem>
          <InfoItem>
            <InfoItemName>배너 제목</InfoItemName>
            <BannerTitle>내용</BannerTitle>
          </InfoItem>
          <InfoItem>
            <InfoItemName>링크할 API</InfoItemName>
            <LinkAPI>내용</LinkAPI>
          </InfoItem>
          <InfoItem>
